            ...
            <Box
                sx={{
                    ...
                    '@media (min-width: 300px)': {
                        ...
                        '& > :not(style)': {
                            minWidth: '400px',
                            // Increase minWidth for larger screens
                        },
                    },
                }}
            >
                ...
                <Paper elevation={0} sx={{ width: '100%', height: '103.5%', display: 'flex', background: '#F3F0EB', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Paper elevation={0} sx={{ width: '103.5%', height: '100%', display: 'flex', background: '#F3F0EB', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
